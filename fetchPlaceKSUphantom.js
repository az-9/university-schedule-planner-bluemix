        ...
        waitFor(function check() {
            return page.evaluate(function () {
                ...
                var output = page.evaluate(function () {
                    ...
                    return $.map($(".pui-dropdown-item.pui-dropdown-list-item.ui-corner-all",$(".pui-dropdown-items.pui-dropdown-list.ui-widget-content.ui-widget.ui-helper-reset")[1]),function(ele){return ele.firstChild.data});
